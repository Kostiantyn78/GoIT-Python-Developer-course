...
class Auth:
    ...
    async def decode_refresh_token(self, refresh_token: str):
        ...
        The decode_refresh_token function is used to decode the refresh token.
            ...
            If unsuccessful, it raises an HTTPException with status code 401 (Unauthorized)
            and detail message 'Invalid scope for token' or 'Could not validate credentials'.
    ...
    async def get_email_from_token(self, token: str):
        ...
        The function first tries to decode the token using jwt.decode().
        If successful, it will return the email address associated with that user's account.
