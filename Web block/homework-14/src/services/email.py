...
async def send_email(email: EmailStr, username: str, host: str):
    ...
    The send_email function sends an email to the user with a link to verify their account.
        The function takes in three parameters:
            ...
            - username: the name of the user that will be displayed on their profile page and
              in other places throughout Contacts Systems.
              This parameter is not required, but it helps personalize emails sent by Contacts Systems and
              makes them more friendly for users who are new to our service.
