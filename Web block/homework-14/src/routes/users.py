...
async def get_me(current_user: User = Depends(auth_service.get_current_user)):
    ...
    get:
        ...
        responses:  # The possible responses that can be returned by this function, and their status codes.
                      This is a helpful way to document what your API will return when called with different parameters
                      or in different states of operation.
                      It also helps you think about how you want to handle errors and other exceptional cases!
